...
import { setFilters, getSongs, goToPage } from "../slice";
import { useEffect, useState } from "react";
import { CloseOutlined } from "@ant-design/icons";

function Filter() {
  const { filters, page } = useSelector((state) => state.songs);
  ...
  return (
    <Form onFinish={onSearch} className={styles.formContainer}>
      <div className={styles.formAreaContainer} onFinish={onSearch}>
        <div>
